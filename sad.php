...
<html lang="en">
	...
	<div class="container">
	<div class="col-sm-3">
		<?php panel_include("User","sad_user.php"); ?>
	<?php panel_include("Menu","sad_menu.php"); ?>
	</div>
	<div class="col-sm-9">
	<?php panel_include($title,"sad_body.php" ,"primary"); ?>
	</div>
	</div>
	
	<?php
 readfile("gs://$appid/footer8.html");
 echo "<br><a href='?p=edit&file=header7.html' class='btn btn-default'>แก้ไข header</a>";
 echo "<a href='?p=edit&file=footer7.html' class='btn btn-default'>แก้ไข footer</a>";
?>
	</body>
	</html>
